...
from .GatedMLP import DropoutLayers, GatedMLPConfig, QKVAttention, SpatialGatingUnit2
...
class MBConv2d(nn.Module):
    def __init__(
        ...
        layers += [
            MBConv2dUnit(ffn_channels, ffn_channels, kernel_size, stride, groups=ffn_channels, norm_layer=norm_layer)
        ]
